...
export default function StockTransfersIncomingPage() {
  ...
  return (
    <ProtectedPageShell
      title="Transfer Stok Incoming"
      description="Tinjau permintaan transfer yang masuk ke outlet aktif dan proses approve atau reject sesuai policy outlet tujuan."
    >
